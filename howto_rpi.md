...
The tools and techniques presented here is not specific to Raspberry Pi. In fact, all of the
BLE related commands (`hciconfig, hcitool, gatttool`) work on linux machines as well.
